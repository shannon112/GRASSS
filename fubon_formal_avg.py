...
for gap in range(args.gaps):
    for year in range(args.start, args.end + 1):
        ...
        for idx, stock_id in enumerate(stock_list):
            ...
            stock_history_buy = yf_ticker.history(
                start=vest_start_date, end=vest_end_date
            )
            ...
            bought_stock = fubon_dollar_cost_averaging(
                stock_id, stock_history_buy, 1000, 1000, 1000
            )
